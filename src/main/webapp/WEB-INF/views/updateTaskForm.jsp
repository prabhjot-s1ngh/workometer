...
<html>
    ...
    <body>
        ...
        <div class="container">        
            ...
            <h3>${message}</h3>
            <form:form action="${contextPath}/PM/leader/taskUpdate" method="POST" modelAttribute="task">
                <table>
                    <tr>
                        <td>Task ID</td>
                    ...
                    <tr>
                        <td>End Date</td>
                        <td><form:input id="endDate" type="date" path="endDate"></form:input></td>
                        <td><form:errors path="endDate"/></td>
                    </tr>
                </table>

                <input type="submit" class="btn btn-dark"  value="Update" onclick="disableEndate()">
            </form:form>
