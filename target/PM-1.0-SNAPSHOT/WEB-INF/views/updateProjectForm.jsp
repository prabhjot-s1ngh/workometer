...
<html>
    ...
    <body>
        ...
        <div class="container">        
            ...
            <h3>${message}</h3>
        <form:form action="${contextPath}/PM/admin/projectUpdate" method="POST" modelAttribute="project">

            <table>
                <tr>
                    <td>ID</td>
                    <td><form:input path="projectId" readonly="${isReadble}" ></form:input></td>
                ...
                <tr>
                    <td colspan="2"><input type="submit"   class="btn btn-dark"  value="Update"></td>
                </tr>
            </table>
